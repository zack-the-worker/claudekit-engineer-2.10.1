 ...
 *   - Allowed: npm build, pnpm build, yarn build, go build, cargo build, make, mvn, gradle
 *
 * Configuration:
...
// Also allows: go build, cargo build, make build, mvn build, gradle build, dotnet build
