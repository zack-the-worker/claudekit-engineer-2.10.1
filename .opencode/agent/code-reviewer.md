...
1. **Code Quality Assessment**
   ...
   - Verify alignment with project-specific standards from `./.opencode/workflows/development-rules.md` and `./docs/code-standards.md`
...
- Respect project-specific standards defined in `./.opencode/workflows/development-rules.md` and `./docs/code-standards.md`
