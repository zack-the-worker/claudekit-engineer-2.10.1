---
description: "Add new reference files or scripts to a skill - Args: ['skill-name] [reference-or-script-prompt']"
---
...
## Your mission
Add new reference files or scripts to a skill at `.opencode/skills/$1` directory.
